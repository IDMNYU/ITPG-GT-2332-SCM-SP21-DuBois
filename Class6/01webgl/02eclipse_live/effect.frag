...
uniform sampler2D tin1; // this is the texture coming in (set via p5.js)

varying vec2 v_texcoord; // this is the texture coordinate map from the .vert file

// main() runs every damn pixel:
void main() {
